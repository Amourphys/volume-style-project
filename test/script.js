...
/* harmony import */ var _modules_scrolling__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/scrolling */ "./src/js/modules/scrolling.js");
/* harmony import */ var _modules_requestAnimScrolling__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/requestAnimScrolling */ "./src/js/modules/requestAnimScrolling.js");
/* harmony import */ var _modules_drop__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/drop */ "./src/js/modules/drop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_changeCalcData__WEBPACK_IMPORTED_MODULE_7__["default"])(calcData);
  ...
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_13__["default"])('.burger-menu', '.burger'); //scrolling('.pageup');

  Object(_modules_requestAnimScrolling__WEBPACK_IMPORTED_MODULE_15__["default"])('.pageup');
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_16__["default"])();
});
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  function choiseParam(event, elem) {
    elem.addEventListener(event, function (e) {
      ...
      Object(_services_request__WEBPACK_IMPORTED_MODULE_1__["getResource"])('http://localhost:3000/calcdata').then(function (res) {
        calcFunc(res);
      }).catch(function (e) {
...
/***/ "./src/js/modules/changeCalcData.js":
/*!******************************************!*\
  !*** ./src/js/modules/changeCalcData.js ***!
  \******************************************/
/*! exports provided: default */
...
var changeCalcData = function changeCalcData(state) {
...
/* harmony default export */ __webpack_exports__["default"] = (changeCalcData);
    ...
    input.addEventListener('drop', function (e) {
      ...
      if (input.closest('main')) {
        ...
        var _postData = function _postData(url, data) {
          var res;
          return regeneratorRuntime.async(function _postData$(_context) {
            while (1) {
        ...
        _postData('assets/server.php', formData).then(function (res) {
...
var jsAccordion = function jsAccordion(triggerSelector) {
  var btns = document.querySelectorAll(triggerSelector);
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var _this = this;
...
/* harmony default export */ __webpack_exports__["default"] = (jsAccordion);
...
var modals = function modals() {
  ...
  var paddingOffsetNow = window.innerWidth - document.body.offsetWidth + 'px';
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        gift.style.paddingRight = gift.style.paddingRight + paddingOffsetNow;
      });
    });
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); //if (!btnPressed && (window.pageYOffset + document.documentElement.clientHeight >= scrollHeight/2) // ловим скролл в середине 
...
/***/ "./src/js/modules/requestAnimScrolling.js":
/*!************************************************!*\
  !*** ./src/js/modules/requestAnimScrolling.js ***!
  \************************************************/
/*! exports provided: default */
...
var requestAnimationScrolling = function requestAnimationScrolling(upSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (requestAnimationScrolling);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      card.classList.add('animated', 'col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1');
...
/*  formData.append(state, document.querySelector('.calc-price').textContent);
                      ...
                      for (let key in formChild) {
                          ...
                          } else if (formChild[key].classList === 'calc-price') {
                              formData.append(formChild[key], formChild[key].value);
                      }
              } */
